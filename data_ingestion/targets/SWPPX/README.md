...
## Purpose
Target-series ingestion module for prediction target `SWPPX`.
...
### Output
- Raw series: `data_ingestion/OUTPUT/raw/SWPPX.csv`
- Metadata: `data_ingestion/OUTPUT/metadata/SWPPX.json`
