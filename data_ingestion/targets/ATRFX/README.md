...
## Purpose
Target-series ingestion module for prediction target `ATRFX`.
...
### Output
- Raw series: `data_ingestion/OUTPUT/raw/ATRFX.csv`
- Metadata: `data_ingestion/OUTPUT/metadata/ATRFX.json`
