...
## Purpose
Target-series ingestion module for prediction target `NASDX`.
...
### Output
- Raw series: `data_ingestion/OUTPUT/raw/NASDX.csv`
- Metadata: `data_ingestion/OUTPUT/metadata/NASDX.json`
