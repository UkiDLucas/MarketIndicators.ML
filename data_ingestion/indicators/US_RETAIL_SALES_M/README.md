...
## Purpose
Ingestion module for `US_RETAIL_SALES_M`.

## Source
- Full name: United States Retail Sales m/m
- Primary URL: `https://www.mql5.com/en/economic-calendar/united-states/retail-sales-mm/export`
...
### Output
- Raw series: `data_ingestion/OUTPUT/raw/US_RETAIL_SALES_M.csv`
- Metadata: `data_ingestion/OUTPUT/metadata/US_RETAIL_SALES_M.json`
