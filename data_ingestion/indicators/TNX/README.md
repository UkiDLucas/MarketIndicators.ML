...
## Purpose
Ingestion module for `TNX`.

## Source
- Full name: Treasury Yield 10 Years (^TNX)
- Primary URL: `https://query1.finance.yahoo.com/v7/finance/download/%5ETNX?period1=-252374400&period2=1602028800&interval=1d&events=history`
...
### Output
- Raw series: `data_ingestion/OUTPUT/raw/TNX.csv`
- Metadata: `data_ingestion/OUTPUT/metadata/TNX.json`
