...
## Purpose
Ingestion module for `VINIX`.

## Source
- Full name: Vanguard Institutional Index Fund Institutional Shares (VINIX)
- Primary URL: `https://query1.finance.yahoo.com/v7/finance/download/VINIX?period1=649382400&period2=1602028800&interval=1d&events=history`
...
### Output
- Raw series: `data_ingestion/OUTPUT/raw/VINIX.csv`
- Metadata: `data_ingestion/OUTPUT/metadata/VINIX.json`
