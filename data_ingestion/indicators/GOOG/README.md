...
## Purpose
Ingestion module for `GOOG`.

## Source
- Full name: Alphabet Inc. (GOOG)
- Primary URL: `https://query1.finance.yahoo.com/v7/finance/download/GOOG?period1=1092873600&period2=1607990400&interval=1d&events=history&includeAdjustedClose=true`
...
### Output
- Raw series: `data_ingestion/OUTPUT/raw/GOOG.csv`
- Metadata: `data_ingestion/OUTPUT/metadata/GOOG.json`
