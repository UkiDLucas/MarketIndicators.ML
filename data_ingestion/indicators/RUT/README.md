...
## Purpose
Ingestion module for `RUT`.

## Source
- Full name: Russell 2000 (^RUT)
- Primary URL: `https://query1.finance.yahoo.com/v7/finance/download/%5ERUT?period1=558230400&period2=1607990400&interval=1d&events=history&includeAdjustedClose=true`
...
### Output
- Raw series: `data_ingestion/OUTPUT/raw/RUT.csv`
- Metadata: `data_ingestion/OUTPUT/metadata/RUT.json`
