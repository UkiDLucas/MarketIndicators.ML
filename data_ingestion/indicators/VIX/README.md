...
## Purpose
Ingestion module for `VIX`.

## Source
- Full name: CBOE Volatility Index (^VIX)
- Primary URL: `https://query1.finance.yahoo.com/v7/finance/download/%5EVIX?period1=631238400&period2=1602028800&interval=1d&events=history`
...
### Output
- Raw series: `data_ingestion/OUTPUT/raw/VIX.csv`
- Metadata: `data_ingestion/OUTPUT/metadata/VIX.json`
