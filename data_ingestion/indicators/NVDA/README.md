...
## Purpose
Ingestion module for `NVDA`.

## Source
- Full name: NVIDIA Corporation (NVDA)
- Primary URL: `https://query1.finance.yahoo.com/v7/finance/download/NVDA?period1=916963200&period2=1602028800&interval=1d&events=history`
...
### Output
- Raw series: `data_ingestion/OUTPUT/raw/NVDA.csv`
- Metadata: `data_ingestion/OUTPUT/metadata/NVDA.json`
