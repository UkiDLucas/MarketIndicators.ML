...
## Purpose
Ingestion module for `GELYF`.

## Source
- Full name: Geely Automobile Holdings Limited (GELYF)
- Primary URL: `https://query1.finance.yahoo.com/v7/finance/download/GELYF?period1=1167782400&period2=1607299200&interval=1d&events=history&includeAdjustedClose=true`
...
### Output
- Raw series: `data_ingestion/OUTPUT/raw/GELYF.csv`
- Metadata: `data_ingestion/OUTPUT/metadata/GELYF.json`
