...
## Purpose
Ingestion module for `CRUDE_OIL`.

## Source
- Full name: Crude Oil Jan 21 (CL=F)
- Primary URL: `https://query1.finance.yahoo.com/v7/finance/download/CL=F?period1=966988800&period2=1607990400&interval=1d&events=history&includeAdjustedClose=true`
...
### Output
- Raw series: `data_ingestion/OUTPUT/raw/CRUDE_OIL.csv`
- Metadata: `data_ingestion/OUTPUT/metadata/CRUDE_OIL.json`
