...
## Purpose
Ingestion module for `RERGX`.

## Source
- Full name: American Funds EuroPacific Growth Fund Class R-6 (RERGX)
- Primary URL: `https://query1.finance.yahoo.com/v7/finance/download/RERGX?period1=1241136000&period2=1602028800&interval=1d&events=history`
...
### Output
- Raw series: `data_ingestion/OUTPUT/raw/RERGX.csv`
- Metadata: `data_ingestion/OUTPUT/metadata/RERGX.json`
