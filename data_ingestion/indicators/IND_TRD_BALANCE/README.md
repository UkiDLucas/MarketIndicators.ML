...
## Purpose
Ingestion module for `IND_TRD_BALANCE`.

## Source
- Full name: India Goods Trade Balance
- Primary URL: `https://www.mql5.com/en/economic-calendar/india/goods-trade-balance/export`
...
### Output
- Raw series: `data_ingestion/OUTPUT/raw/IND_TRD_BALANCE.csv`
- Metadata: `data_ingestion/OUTPUT/metadata/IND_TRD_BALANCE.json`
